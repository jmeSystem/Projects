...
public class JmeClienteBean implements Serializable {
	...
	public void excluir(){
		...
		if(registroVendas!=null){
			JSFUtil.adicionarMensagemErro("Impossível excluir o Cliente, o mesmo está sendo utilizado na Venda. Para excluir o cliente, exclui a Venda referente ao cliente");
			return;
		}
