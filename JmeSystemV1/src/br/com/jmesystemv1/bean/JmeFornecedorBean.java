...
public class JmeFornecedorBean implements Serializable{
	...
	public void novo(){
		...
		/**Limpa os combos depois que os dados sÃ£o salvos*/
		fornecedorBean = new JmeFornecedor();
		
		JSFUtil.adicionarMensagemSucesso("Salvo com sucesso.");
		}catch(Exception ex){
			ex.printStackTrace();
			JSFUtil.adicionarMensagemErro("Erro ao salvar o fornecedor"+ex.getMessage());
		}
	...
	public void excluir(){
		...
		try{
			...
			produto = daoProduto.buscarPorFornecedor(fornecedorBean.getIdFornecedor());
			
			if(produto !=null){
				JSFUtil.adicionarMensagemErro("Impossível excluir o Fornecedor, o mesmo está sendo utilizado no Produto. Para excluir o Fornecedor, exclui o produto que está utilizando o fornecedor");
				return;
			}
			...
			ex.printStackTrace();
			JSFUtil.adicionarMensagemErro("Erro ao excluir o fornecedor"+ex.getMessage());
		}
	}
	...
	public void editar(){
		...
		try{
			...
			ex.printStackTrace();
			JSFUtil.adicionarMensagemErro("Erro ao alterar o fornecedor"+ex.getMessage());
		}
	}
}
